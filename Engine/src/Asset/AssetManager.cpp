...
bool AssetManager::ResolveMesh3D(Mesh3DComponent& mesh)
{
    ...
    {
        // Revision suffix invalidates GPU cache when MeshImporter / Assimp flags change.
        static constexpr const char kImportRevision[] = "@mi4";
        const std::string cacheKey = key + kImportRevision;
